...
import { LayoutDashboard, Settings, LogOut, Menu, Megaphone, Rocket, CreditCard, Sparkles } from "lucide-react"
...
const navigation = [
    ...
    { name: "Automation Campaigns", href: "/automation-campaigns", icon: Sparkles, translationKey: 'nav.automation' },
